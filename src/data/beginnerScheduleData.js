export const beginnerHeadingData = [
    {
        head: "Week 1"
    },
    {
...
export const beginnerContentData = [
    {
        heading: "Ideation",
    ...
    },
    {
        ...
        preContent: "",
        content: [
            "Showcase your project to the community and to the industry experts, recruiters and founders who would be part of the demo day."
        ]
    },
]

export const beginnerSessionData = [
    {
        content: [
            {
